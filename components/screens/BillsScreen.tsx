...
import { Language, BillEntry } from '../../common/types';
import { translations } from '../../common/constants';
import { getBills } from '../../common/api';
...
const BillsScreen: React.FC<BillsScreenProps> = ({ language }) => {
  ...
  useEffect(() => {
    const fetchBills = async () => {
      try {
        setIsLoading(true);
        // @ts-ignore - This is expected to fail as the component is outdated and doesn't pass the user prop required by the new api.
